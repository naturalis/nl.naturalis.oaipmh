...
public class ResumptionTokenTest {
	...
	/*
	 * Tests resumption token generation by parsing the generated resumption
	 * token back into an OAIPMHRequest and ensuring it has the same data.
	 * except for the page, which should be one higher than for the original
	 * request.
	 * 
