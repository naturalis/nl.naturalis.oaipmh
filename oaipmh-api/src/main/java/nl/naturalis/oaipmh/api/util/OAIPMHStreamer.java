...
/**
 * Class that can aid repository implementations in streaming the OAI-PMH they have generated to the {@link java.io.OutputStream}
 * provided by the REST layer.
 * 
...
public class OAIPMHStreamer {
  ...
  /**
   * Adds a package containing JAXB classes. The following packages are automatically added:
   * <ol>
   ...
   * </ol>
   * If you implement you {@link IOAIRepository} using JAXB, you must add any extra packages (most likely generated by xjc) used to
   * generate the final OAI-PMH output.
   * 
   * @param pkg
   */
  ...
  /**
   * Expands the {@code xsi:schemaLocation} attribute of the &lt;OAI-PMH&gt; root element with the specified namespace-location
   * pair. The schema location of the XSD for OAI-PMH is automatically added. The XSD location for oai_dc, however, is not
   * automatically added since you might be serving a request for a different metadata format. However, you can simply add the XSD
   * location for oai_dc by calling {@link #addOaiDcSchemaLocation()}.
   * 
  ...
  /**
   * Adds the XSD location of the oai_dc namespace. See {@link #addSchemaLocation(String, String)}.
   */
