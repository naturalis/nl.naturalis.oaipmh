...
/**
 * A {@code DocumentNotes} instance maintains the values of all relevant notes within the document_xml column. The document_xml
 * column may contain a &lt;notes&gt; element. The &lt;notes&gt; element contains one or more &lt;note&gt; elements. Each
 * &lt;note&gt; element contains one child element whose name identifies the note, for example &lt;BOLDIDCode_BOLD&gt;. Not all of
 * these child elements are relevant to the OAI-PMH generation process. Only those whose name corresponds to a {@link Note}
 * constant are extracted from the XML.
 * 
...
public class DocumentNotes {
  ...
  /**
   * Enumerates all XML elements that contain a note that might be used for OAI-PMH generation. These elements are nested within a
   * &lt;note&gt; element.
   * 
   * @author Ayco Holleman
   *
  ...
  public static enum Note {
    ...
    /**
     * Maps to unitID for specimens; maps to associatedUnitID for DNA extracts.
     */
  ...
  public boolean equals(Object obj) {
    ...
    DocumentNotes other = (DocumentNotes) obj;
