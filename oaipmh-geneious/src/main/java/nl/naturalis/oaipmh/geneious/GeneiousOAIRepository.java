...
/**
 * Abstract base class for all Geneious OAI repositories (one for specimens, one for DNA extracts and one for DNA extract plates).
 * Provides the implementation of {@link IOAIRepository#getXSDForMetadataPrefix(OutputStream, String) getXSDForMetadataPrefix} and
 * {@link IOAIRepository#init(OAIPMHRequest) init} and provides no-op implementations of the other methods defined by
 * {@link IOAIRepository}.
 * 
