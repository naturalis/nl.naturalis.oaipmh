...
/**
 * A {@link Comparator} for {@link AnnotatedDocument} instances that, per plate number, selects the instance with the highest
 * database ID.
 * 
...
public class PlateNumberComparator implements Comparator<AnnotatedDocument> {
  ...
  private static final Logger logger = LoggerFactory.getLogger(PlateNumberComparator.class);
