...
public class GeneiousOAIUtil {
  ...
  /**
   * Returns whether or not the specified document represents a fasta document (a&#46;k&#46;a&#46; fasta record). This is considered
   * to be the case if:
   * <ol>
   * <li>The document_xml column contains a &lt;note&gt; element containing a &lt;filename&gt; whose value ends with ".fas"
   * </ol>
   * 
   * @param ad
   * @return
  ...
  /**
   * Returns whether or not the specified document represents a contig document (a&#46;k&#46;a&#46; contig record). This is
   * considered to be the case if:
   * <ol>
  ...
  /**
   * Returns whether or not the specified document represents a consensus document (a&#46;k&#46;a&#46; consensus record). This is
   * considered to be the case if:
   * <ol>
   * <li>The plugin_xml column has a &lt;XMLSerialisableRootElement&gt; root element
   * <li>The XML in plugin_xml contains a &lt;name&gt; whose value ends with "consensus sequence". In other words whatever name the
   * Geneious user wants to give to the consensus sequence record, the last two words <b>must</b> be "consensus sequence" (case
   * sensitive), otherwise this module will not be able to identify consensus sequence records and the OAI-PMH it generates will not
   * be correct!
   * </ol>
   * 
   * @param ad
