...
/**
 * A {@link IAnnotatedDocumentPostFilter post-filter} shared by all geneious repositories. Will be applied <i>before</i> any
...
public class SpecimenPostFilter implements IAnnotatedDocumentPostFilter {
  ...
  private static final Logger logger = LoggerFactory.getLogger(SpecimenPostFilter.class);
