...
/**
 * A {@link IAnnotatedDocumentPreFilter Pre-filter} shared by all {@link GeneiousOAIRepository geneious repositories}. This class
 * contains course-grained logic for filtering out irrelevant or corrupt records.
 * <ul>
 * <li>The document_xml column is not null or empty
 * <li>The plugin_document_xml column is not null or empty
 * <li>The document root of the XML within the plugin_document_xml column is one of &lt;XMLSerialisableRootElement&gt;,
...
public class SharedPreFilter implements IAnnotatedDocumentPreFilter {
  ...
  private static final Logger logger = LoggerFactory.getLogger(SharedPreFilter.class);
