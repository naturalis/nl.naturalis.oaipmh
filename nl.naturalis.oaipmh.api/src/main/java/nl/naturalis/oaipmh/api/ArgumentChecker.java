...
/**
 * Abstract base class for classes that check the validity of the
 * {@link Argument arguments} passed allong with a certain {@link VerbType verb}
 * . For each verb has there is a subclass of this base class. An
 * {@code ArgumentChecker} does <i>not</i> check the value of the arguments. It
 * only checks that all required arguments are present, forbidden arguments are
 * absent, and mutually exclusive arguments are not both present.
 * 
...
public abstract class ArgumentChecker {
	...
	/**
	 * Checks the validity of the provided arguments. The {@link Argument#VERB
	 * verb} itself must not be present in the provided set of arguments.
	 * 
	 * @param arguments
	 * @return
	 */
	...
	/**
	 * Hook for subclasses to expand and control the argument checking process.
	 * Called at the beginning of the {@link #check(EnumSet) check} method. If
	 * the {@code beforeCheck} method returns {@code false}, no further checks
	 * are done and the {@code check} method returns immediately.
	 * 
	 * @param arguments
	 * @param errors
	 * @return
	...
	/**
	 * To be implemented by subclasses: get the required arguments for the
	 * {@link VerbType verb} that the subclass deals with.
	 * 
	 * @return
	 */
	...
	/**
	 * To be implemented by subclasses: get the optional arguments for the
	 * {@link VerbType verb} that the subclass deals with.
	 * 
	 * @return
	 */
